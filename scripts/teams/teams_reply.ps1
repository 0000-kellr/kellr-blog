...
$body = @{ conversationId = $ConversationId; text = $Text } | ConvertTo-Json

Invoke-RestMethod -Method Post -Uri "$fnUrl/api/openclaw/reply" -Headers $headers -Body $body -TimeoutSec 30 | ConvertTo-Json -Depth 6
